...
from retriever.tools.retrieval.lang_chain import (
...
def test_wiki_retriever() -> None:
    ...
    with patch(
        "retriever.tools.retrieval.lang_chain.WikipediaRetriever",
...
def test_vector_db_retriever() -> None:
    file_path = "src/retriever/tests/test_data/Mariana_Trench.pdf"
    ...
    mock_docs = [
        Document(
            ...
            metadata={
                "page": 0,
                "source": "src/retriever/tests/test_data/Mariana_Trench.pdf",
            },
        ),
        Document(
